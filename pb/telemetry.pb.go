...
// Telemetry used to stream agent system stats to server
type Telemetry struct {
	...
	Load2      float32 `protobuf:"fixed32,2,opt,name=load2,proto3" json:"load2,omitempty"`
	Load3      float32 `protobuf:"fixed32,3,opt,name=load3,proto3" json:"load3,omitempty"`
	MemoryUsed int64   `protobuf:"varint,4,opt,name=memoryUsed,proto3" json:"memoryUsed,omitempty"`
	MemoryFree int64   `protobuf:"varint,5,opt,name=memoryFree,proto3" json:"memoryFree,omitempty"`
}
...
func (x *Telemetry) GetLoad1() float32 {
	if x != nil {
		return x.Load1
	}
	return 0
...
func (x *Telemetry) GetLoad2() float32 {
	if x != nil {
		return x.Load2
	}
	return 0
...
func (x *Telemetry) GetLoad3() float32 {
	if x != nil {
		return x.Load3
	}
	return 0
...
func (x *Telemetry) GetMemoryUsed() int64 {
	if x != nil {
		return x.MemoryUsed
	}
	return 0
...
func (x *Telemetry) GetMemoryFree() int64 {
	if x != nil {
		return x.MemoryFree
	}
	return 0
...
var file_telemetry_proto_rawDesc = []byte{
	...
	,
